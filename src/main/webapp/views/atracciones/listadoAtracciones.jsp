			...
			<tbody>
				<c:forEach items="${atracciones}" var="atraccion">
					<tr>
						...
						<td>
							<a href="/TurismoTMTP3/atracciones/verAtraccion.do?id_atraccion=${atraccion.id_atraccion}"
								class="btn btn-success rounded" role="button">Ver Atracción</a>
							<a href="/TurismoTMTP3/atracciones/edit.do?id_atraccion=${atraccion.id_atraccion}"
								class="btn btn-light rounded-0" role="button">Editar
								<i class="bi bi-pencil-fill"></i></a>
							<a href="/TurismoTMTP3/atracciones/delete.do?id_atraccion=${atraccion.id_atraccion}"
